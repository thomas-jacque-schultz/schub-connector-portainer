...
| | |
|---|---|
| Paquet racine | `schultz.thomas.schub.connector.portainer` |
| Image Docker | `thomasschultzschub/schub-connector-portainer` |
| Port en dev | 18086 (vers 8080 dans le conteneur) |
